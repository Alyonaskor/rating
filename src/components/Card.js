...
export default function Card({index, hero, updateRating }) {
    ...
    return (
        <div className=" flex justify-between bg-[#FFFFFF] md:h-[150px]  mx-2 md:mx-0 mb-3 md:mb-[18px]">
            <div className="flex">
                ...
                <div className="h-10 md:h-[116px] mt-2 md:mt-[19px] md:mb-[15px] ">
                    <p style={{ color: hero.color }} className="text-start font-raleway text-base md:font-raleway-xl md:text-xl"> {hero.name}</p>
                    <p className="text-start font-raleway text-xs md:text-base my-1 md:my-3"> {hero.single}</p>
